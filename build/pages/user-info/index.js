...
var _default = {
  ...
  async onInit() {
    const username = await $utils.getStorage(_constants.username_key);
  ...
  handleAboutClick(type) {
    switch (type) {
      case '注销登录':
        $utils.removeStorage(_constants.username_key);
        $utils.removeStorage(_constants.uid_key);
...
(() => {
/*!**************************************************!*\
  !*** ./src/pages/user-info/index.ux?uxType=page ***!
  \**************************************************/
